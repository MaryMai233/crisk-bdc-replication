...
esttab h2_1 h2_2 h2_3 h2_4 h2_5 h2_6 using ///
    ...
    keep(`brown') b(3) se(3) nostar label compress ///
    ...
    addnotes("Standard errors are clustered by BDC and appear in parentheses." ///
             "Inference is two-sided; this companion table suppresses significance stars.")
...
esttab factor_1 factor_2 factor_3 factor_4 factor_5 factor_6 using ///
    ...
    keep(z_brown_share_broad_dynamic_pct) b(3) se(3) nostar label compress ///
